<form id="createMatterForm" autocomplete="on" class="ui-front">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control" data-ac="/category/autocomplete" data-actarget="category_code" data-aclength="0" placeholder="{{ $category['name'] ?? ( $parent_matter->category->category ??  '' ) }}" autocomplete="on">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control text-truncate" data-ac="/country/autocomplete" data-actarget="country" placeholder="{{ $parent_matter->countryInfo->name ?? '' }}" autocomplete="on">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control text-truncate" data-ac="/country/autocomplete" data-actarget="origin" placeholder="{{ $parent_matter->originInfo->name ?? '' }}" autocomplete="on">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control" data-ac="/type/autocomplete" data-actarget="type_code" data-aclength="0" value="{{ $parent_matter->type->type ?? '' }}" autocomplete="on">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      @else
      <input type="text" class="form-control" data-ac="/matter/new-caseref" name="caseref" value="{{ $parent_matter->caseref ?? ( $category['next_caseref'] ?? '') }}" autocomplete="on">
      @endif
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control" data-ac="/user/autocomplete" data-actarget="responsible" placeholder="{{ $parent_matter->responsible ?? Auth::user()->name }}" autocomplete="on">
    </div>
  </div>
